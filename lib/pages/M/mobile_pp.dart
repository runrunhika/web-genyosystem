...
class MobilPPScreen extends StatefulWidget {
  @override
  _MobilPPScreenState createState() => _MobilPPScreenState();
}

class _MobilPPScreenState extends State<MobilPPScreen> {
  @override
      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
                "我々のアプリは、お客様の個人情報は、弊社への信頼のもとお客様が自らの意志により特定の目的での利用のために弊社に預託されたものであり、この個人情報を安全に保管し、お客様の意志を尊重して利用することが、弊社に課せられた最大の課題であると認識しております。\n弊社は、個人情報に関する法令を遵守し、個人情報の適切な取り扱いを実現致します。"),
          ),
          //小見出し
          Padding(
          ...
          Padding(
            padding:
                const EdgeInsets.only(left: 30, right: 20, top: 35, bottom: 15),
            child: Text(
              "制定日：2021年3月10日",
